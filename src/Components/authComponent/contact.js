					...
					<div className="row">
						...
						<div className="col1">
							<div className="container1">
								...
								<p className="text"><i class="fasC fa fa-map-marker"></i>Room no. 567, Radhakrishnan Bhawan , IIT Roorkee </p>
								<p className="text"><i class='fasC fa fa-call'>&#xf095;</i>+91-911-722-7202</p>
								<div className="social">
									<a href="#"><i class='fasC fa fa-facebook'></i></a>
									<a href="#"><i class='fasC fa fa-instagram'></i></a>
									<a href="#"><i class='fasC fa fa-twitter'></i></a>
								</div>
							</div>
						</div>
					</div>
